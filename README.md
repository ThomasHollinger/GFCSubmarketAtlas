# Gulf Coast Submarket Atlas v2.9.0

This release applies the latest verified school ratings update.

Changes:
- School ratings updated from the verified school review file.
- Builder Subdivisions layer loads correctly with Lennar/Lennar Homes normalization.
