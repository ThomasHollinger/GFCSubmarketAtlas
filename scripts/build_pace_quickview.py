...
OUT_PATH = ROOT / 'data' / 'market_quickview' / 'pace_quickview_blocks.geojson'
...
def main(zip_path: Path):
    ...
    if len(cells) != 45:
        raise RuntimeError(f'Expected 45 Pace blocks from project boundary, generated {len(cells)}')
